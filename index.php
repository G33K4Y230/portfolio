...
<html>
  ...
  <body class="m-0" style="font-family: 'Jersey 25', serif;">
	...
	GIANNELLI ILENDA
      ...
      <section>
	<div id="content-wrapper" class="h-0 max-h-[60vh] ease-in-out duration-300 overflow-hidden">
	  ...
	  <div id="content-contact" class="h-0 collapse">
	    <div class="flex flex-col justify-center items-center h-[25vh] w-[60vw] mb-6 rounded-md border-solid border-2 border-white bg-white/50">
	...
	<ul>
	  ...
	  -
	  <li class="inline mx-3"><a href="#" onclick="showContact()">CONTACT</a></li>
	</ul>
      </nav>
